// To parse this data:
//
//   import { Convert, SearchGifsesponse } from "./file";
//
//   const searchGifsesponse = Convert.toSearchGifsesponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsesponse {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsesponse(json: string): SearchGifsesponse {
        return cast(JSON.parse(json), r("SearchGifsesponse"));
    }

    public static searchGifsesponseToJson(value: SearchGifsesponse): string {
        return JSON.stringify(uncast(value, r("SearchGifsesponse")), null, 2);
    }
}
